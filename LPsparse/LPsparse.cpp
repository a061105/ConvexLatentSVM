...
void exit_with_help(){
	...
	cerr << "-m max_iter: maximum number of outer iterations (default 10000)" << endl;
...
int main(int argc, char** argv){
	...
	//writeVec("sol",x, n+nf, param.nnz_tol);
	writeDenseVec("sol",x, n+nf);
	writeVec("dual_sol", w, m+me, param.nnz_tol);
