		...
		while( iter < max_iter ){
			...
			for(int r=0;r<pos_index.size();r++){
				...
				for(int r2=0;r2<m;r2++){
					...
					omega_ij_act.push_back(make_pair(hh2,0.0));
					//cerr <<"omega_act(1): " ;
			...
			for(int r2=0;r2<m;r2++){
				...
				double Qih2 = rho*num_h_neg + neg_size*R_sq/lambda/lambda*act_size;
